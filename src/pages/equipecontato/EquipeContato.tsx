    ...
    return (
        <div className="bg-[#F5F4D6]">
            <div className="grid grid-cols-2 py-16 px-20">
                <div className="bg-[#364d33] border-4 rounded-l-lg border-black justify-center">
                    <form id="formulario" action="https://formsubmit.co/d425c3abca8e6edad333b3d489546a89" method="POST" className="grid grid-cols-1 item-center justify-center ">
            ...
            <div>
                ...
                <div className="grid grid-cols-3 gap-6 p-6">
                    <div className="flex flex-col items-center bg-[#2B4042] shadow-lg rounded-lg p-6 hover:bg-[#1e5353]">
