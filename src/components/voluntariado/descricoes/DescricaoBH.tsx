                ...
                <div className="flex flex-col h-[90%]">
                    ...
                    <div className="flex flex-col items-center py-4">
                        <div className="flex flex-col items-center">
                            <p className="text-3xl font-semibold text-center py-2">Missão: Bahia</p>
                            <p className="text-3xl text-center py-2 w-3/5">O StartSolidario esta buscando voluntários para trabalhar em construção de moradias, oficinas educativas para capacitação profissional e iniciativas para distribuição de alimentos e desenvolvimento de soluções sustentáveis</p>
                        </div>
                        <div className="flex flex-col items-center py-4">
