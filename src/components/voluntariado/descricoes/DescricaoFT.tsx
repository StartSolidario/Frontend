            ...
            <form className="flex flex-col justify-center items-center w-full h-full text-[#F5F4D6]">
                <div className="flex flex-col justify-evenly h-[90%]">
                    <div className="flex flex-col items-center">
                        <p className="text-4xl font-bold">Destino: Ceará</p>
                    ...
                    <div className="flex flex-col items-center">
                        <div className="flex flex-col items-center py-4">
                            <p className="text-3xl font-semibold text-center py-2 px-6">Missão: Fortaleza</p>
                            <p className="text-2xl text-center py-2 w-4/5">O StartSolidario esta buscando voluntarios para Auxiliar na distribuição de alimentos e materiais de ensino em areas carentes</p>
                        </div>
                        <div className="flex flex-col items-center py-4">
                            ...
                            <div className="flex justify-evenly w-full">
                                ...
                                <p className="text-2xl text-center py-2 px-6 w-1/2">O voluntario que veio de fora de Fortaleza tera moradia e alimentação garantida</p>
                            </div>
                        </div>
                    </div>
                </div>
