                ...
                <div className="flex flex-col justify-evenly h-[90%]">
                    ...
                    <div className="flex flex-col items-center">
                        <div className="flex flex-col items-center py-4">
                            <p className="text-3xl font-semibold text-center py-2 px-6">Missão: São Paulo</p>
                            <p className="text-2xl text-center py-2 w-4/5">O StartSolidario esta buscando voluntarios para Trabalhar em cozinhas comunitarias e abrigos quando o frio chegar</p>
                        </div>
                        <div className="flex flex-col items-center py-4">
