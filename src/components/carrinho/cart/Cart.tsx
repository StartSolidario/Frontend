...
function Cart() {
    ...
    return (
        <div className="bg-yellow-100 flex flex-col justify-center pb-8 min-h-[80vh]">
            ...
            <button className="rounded text-slate-100 bg-emerald-600 hover:bg-emerald-800 border border-slate-700 w-1/4 py-2 mx-auto flex justify-center mt-8"
                type="submit"
